...
func (x *SetRequest) Reset() {
	*x = SetRequest{}
	mi := &file_proto_bigtablelite_proto_msgTypes[0]
...
func (*SetRequest) Descriptor() ([]byte, []int) {
	return file_proto_bigtablelite_proto_rawDescGZIP(), []int{0}
}
...
func (x *SetResponse) Reset() {
	*x = SetResponse{}
	mi := &file_proto_bigtablelite_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SetResponse) Descriptor() ([]byte, []int) {
	return file_proto_bigtablelite_proto_rawDescGZIP(), []int{1}
}
...
func (x *GetRequest) Reset() {
	*x = GetRequest{}
	mi := &file_proto_bigtablelite_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetRequest) Descriptor() ([]byte, []int) {
	return file_proto_bigtablelite_proto_rawDescGZIP(), []int{2}
}
...
func (x *GetResponse) Reset() {
	*x = GetResponse{}
	mi := &file_proto_bigtablelite_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GetResponse) Descriptor() ([]byte, []int) {
	return file_proto_bigtablelite_proto_rawDescGZIP(), []int{3}
}
...
const file_proto_bigtablelite_proto_rawDesc = "" +
	"\n" +
	"\x18proto/bigtablelite.proto\x12\fbigtablelite\"4\n" +
	"\n" +
	"SetRequest\x12\x10\n" +
...
var (
	...
	file_proto_bigtablelite_proto_rawDescData []byte
)

func file_proto_bigtablelite_proto_rawDescGZIP() []byte {
	file_proto_bigtablelite_proto_rawDescOnce.Do(func() {
		file_proto_bigtablelite_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_proto_bigtablelite_proto_rawDesc), len(file_proto_bigtablelite_proto_rawDesc)))
	})
...
func init() { file_proto_bigtablelite_proto_init() }
func file_proto_bigtablelite_proto_init() {
	if File_proto_bigtablelite_proto != nil {
		return
	}
	type x struct{}
	out := protoimpl.TypeBuilder{
		...
		GoTypes:           file_proto_bigtablelite_proto_goTypes,
		DependencyIndexes: file_proto_bigtablelite_proto_depIdxs,
		MessageInfos:      file_proto_bigtablelite_proto_msgTypes,
	}.Build()
	File_proto_bigtablelite_proto = out.File
	file_proto_bigtablelite_proto_goTypes = nil
	file_proto_bigtablelite_proto_depIdxs = nil
}
